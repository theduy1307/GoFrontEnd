...
const display = ref<any>(false)
const displayConfirmation = ref<any>(false)
const visibleLeft = ref<any>(false)
const visibleRight = ref<any>(false)
const visibleTop = ref<any>(false)
const visibleBottom = ref<any>(false)
const visibleFull = ref<any>(false)
