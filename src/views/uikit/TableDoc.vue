...
import { CustomerService, type Customer } from '@/service/CustomerService'
...
function expandAll() {
  expandedRows.value = products.value.reduce((acc: any, p) => (acc[p.id] = true) && acc, {})
}
